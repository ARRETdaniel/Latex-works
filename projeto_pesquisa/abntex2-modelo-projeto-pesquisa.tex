...
% ---
\titulo{Inteligência Artificial em Veículos Autônomos: \\um estudo sobre a implementação no Brasil}
\autor{Daniel Terra Gomes}
\local{Campos dos Goytacazes, RJ}
\data{22.06.2022 v1.0.0}
\instituicao{%
Universidade Estadual do Norte Fluminense Darcy Ribeirol - UENF
  \par
