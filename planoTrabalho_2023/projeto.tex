...
Este cronograma visa mostrar o desenvolvimento de atividades (listadas na seção \ref{etapas} e ilustrada na figura \ref{img_bibli}), cada etapa \ref{etapas} foi dividida de modo a otimizar o tempo e as necessidades do projeto.
